...
const TacherListPage = () => {
  const renderRow = (item: Teacher) => (
    ...
    >
      ...
      <td className="hidden pr-4 md:table-cell">{item.teacherId}</td>
      <td className="hidden pr-4 md:table-cell">{item.subjects.join(", ")}</td>
      <td className="hidden pr-4 md:table-cell">{item.classes.join(", ")}</td>
