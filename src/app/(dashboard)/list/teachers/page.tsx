...
const renderRow = (item: TeacherList) => (
  ...
  >
    ...
    <td className="hidden pr-4 md:table-cell">{item.username}</td>
    <td className="hidden pr-4 md:table-cell">{item.subjects.map(subject=>subject.name).join(", ")}</td>
    <td className="hidden pr-4 md:table-cell">{item.classes.map(classItem=>classItem.name).join(", ")}</td>
    <td className="hidden pr-4 lg:table-cell">{item.phone}</td>
