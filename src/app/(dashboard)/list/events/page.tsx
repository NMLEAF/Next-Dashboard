...
const EventListPage = () => {
  const renderRow = (item: Event) => (
    ...
    >
      ...
      <td className="hidden pr-4 md:table-cell">{item.date}</td>
      <td className="hidden pr-4 md:table-cell">{item.startTime}</td>
      <td className="hidden pr-4 md:table-cell">{item.endTime}</td>
      <td>
